...
## 第3章 可视化格式模型
`盒模型`：
![image](http://woojean.com/images/css_1.png)
...
![image](http://woojean.com/images/css_8.png)
...
## 第6章 对列表应用样式和创建导航条
### 创建基本的垂直导航条
![image](http://woojean.com/images/css_9.png)
<ul class="nav">
...
### 创建简单的水平导航条
 ![image](http://woojean.com/images/css_10.png)
 ```html
<ol class="pagination">
...
### 远距离翻转
 ![image](http://woojean.com/images/css_11.png)
...
## 第7章 对表单和数据表格应用样式
定义一个不带样式的表格：
![image](http://woojean.com/images/css_12.png)

添加样式后效果：
![image](http://woojean.com/images/css_13.png)
具体过程略。
...
```
效果：
![image](http://woojean.com/images/css_14.png)
...
`固定布局`：
![image](http://woojean.com/images/css_15.png)

`流式布局`
![image](http://woojean.com/images/css_16.png)
