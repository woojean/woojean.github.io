...
## 第7章 对表单和数据表格应用样式
定义一个不带样式的表格：
![image](/images/css_12.png)

添加样式后效果：
![image](/images/css_13.png)
具体过程略。
...
`固定布局`：
![image](/images/css_15.png)

`流式布局`
![image](/images/css_16.png)
