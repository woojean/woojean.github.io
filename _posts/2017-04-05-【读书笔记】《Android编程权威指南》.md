...
## Android编译过程
 ![image](http://woojean.com/images/android_1.png)
...
![image](http://woojean.com/images/android_2.png)
...
```
## Fragment的生命周期
![image](http://woojean.com/images/android_3.png)
...
可以通过隐式Intent来与照相机进行交互，相机应用会自动侦听MediaStore.ACTION_IMAGE_CAPTURE创建的Intent。
 ![image](http://woojean.com/images/android_4.png)
...
两种方式启动Service的生命周期：
  ![image](http://woojean.com/images/android_5.png)
...
Broadcast Intent可以同时被多个组件接收，Broadcast Receiver负责接收各种Broadcast Intent。
 ![image](http://woojean.com/images/android_6.png)
...
## 使用SQLite本地数据库
 ![image](http://woojean.com/images/android_7.png)
...
Loader的继承关系：
![image](http://woojean.com/images/android_8.png)
